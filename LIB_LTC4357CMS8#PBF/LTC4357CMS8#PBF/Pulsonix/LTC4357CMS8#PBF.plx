...
//1203562/1037340/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LTC4357CMS8#PBF" (originalName "LTC4357CMS8#PBF")
	...
	(compDef "LTC4357CMS8#PBF" (originalName "LTC4357CMS8#PBF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "OUT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VDD") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "NC_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTC4357CMS8#PBF"))
		...
		(attr "Mouser Part Number" "584-LTC4357CMS8#PBF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/LTC4357CMS8PBF?qs=hVkxg5c3xu%252BQOMvU8ilEog%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "LTC4357CMS8#PBF")
		(attr "Description" "Hot Swap Controller 1-CH 80V N-Channel Positive High Voltage Automotive 8-Pin MSOP Tube")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/ltc4357cms8pbf/analog-devices")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "LTC4357CMS8#PBF.stp")
