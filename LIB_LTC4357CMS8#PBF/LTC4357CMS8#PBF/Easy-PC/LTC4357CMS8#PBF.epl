...
(library Library_1
	...
	(symbolDef "LTC4357CMS8_PBF" (originalName "LTC4357CMS8_PBF")
	...
	(compDef "LTC4357CMS8#PBF" (originalName "LTC4357CMS8#PBF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "NC_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTC4357CMS8_PBF"))
		...
		(attr "Datasheet Link" "https://www.arrow.com/en/products/ltc4357cms8pbf/analog-devices")
		(attr "Height" "1.1 mm")
	)
