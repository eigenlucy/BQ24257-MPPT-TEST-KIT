SamacSys ECAD Model
1032486/1037340/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "VN7040ASTR" (originalName "VN7040ASTR")
	...
	(compDef "VN7040ASTR" (originalName "VN7040ASTR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "MULTISENSE") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VCC_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "OUTPUT_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "OUTPUT_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "VCC_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "VN7040ASTR"))
		...
		(attr "Mouser Part Number" "511-VN7040ASTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/VN7040ASTR?qs=N2Tevpb%252BvoafXfmnB0CY5g%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "VN7040ASTR")
		(attr "Description" "Current Limit SW 1-IN 1-OUT to 34A Automotive 8-Pin SO N T/R")
		(attr "Datasheet Link" "https://www.st.com/content/ccc/resource/technical/document/datasheet/5f/e6/42/6c/dc/d9/4c/65/DM00157100.pdf/files/DM00157100.pdf/jcr:content/translations/en.DM00157100.pdf")
		(attr "Height" "1.75 mm")
	)
