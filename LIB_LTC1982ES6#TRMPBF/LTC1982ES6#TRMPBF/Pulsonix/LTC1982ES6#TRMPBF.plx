...
(library Library_1
	...
	(symbolDef "LTC1982ES6#TRMPBF" (originalName "LTC1982ES6#TRMPBF")
	...
	(compDef "LTC1982ES6#TRMPBF" (originalName "LTC1982ES6#TRMPBF") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "__SHDN 1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "GND") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "__SHDN 2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VCC") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GATE 1") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "GATE 2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LTC1982ES6#TRMPBF"))
		...
		(attr "<STEP Filename>" "LTC1982ES6#TRMPBF.stp")
