...
//685039/1037340/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD8218BRMZ-R7" (originalName "AD8218BRMZ-R7")
	...
	(compDef "AD8218BRMZ-R7" (originalName "AD8218BRMZ-R7") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "ENB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "REF") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "NC") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD8218BRMZ-R7"))
		...
		(attr "Mouser Part Number" "584-AD8218BRMZ-R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/AD8218BRMZ-R7?qs=%2FtpEQrCGXCz70zc1CjCIWQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "AD8218BRMZ-R7")
		(attr "Description" "Current Sense Amplifiers ZeroDrift BiDirectional Current SenseAmp")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/AD8218.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "AD8218BRMZ-R7.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=0.58")
